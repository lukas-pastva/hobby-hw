#include <EtherCard.h>
#include <SPI.h>
static uint32_t timer, timerSwitch, timerMon, timerMonWeb, timerNetworkDown, timerNetworkDownCount;
...
void loop () {  
  ...
  if (millis() > timerSwitch) {
    ...
    if(!networkUsed){
      networkUsed = true;
      ether.browseUrl(PSTR("/index.php"), "?action=getswitches&id1=5&id2=11&id3=4&id4=13&id5=15", website, callback);
    }else{
