...
void loop () {  
  ...
  //ale este by som mal povypinat vsetky veci ktore vela spotebuju, hmm, ale iba v pripade ze sa nepodarilo resetnut
  ...
  if (millis() > timerMonWeb) {
    ...
    if(!networkUsed){
      ...
      Serial.println("inGasCOVal"+inGasCOVal);
      sprintf (buff, "?action=record&val1=%s&type1=9&val2=%d&type2=7", str_amp, inGasCOVal);
      //Serial.println(buff);
